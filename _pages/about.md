...
I am a Permanent Researcher (tenured) at [IXA Group](http://ixa.eus), part of the [HiTZ Centre](http://hitz.eus) of the [University of the Basque Country UPV/EHU](http://www.ehu.eus), where I am head of the [Text Analysis unit](http://www.hitz.eus/en/nlp). I got a PhD in Computer Science at City, University of London (2007), and I have since been working on Natural Language Processing at several British and Spanish institutions. I have been involved as PI or collaborator in more than 40 research projects funded by the European Commission, UK research councils, Spanish Ministry of Science, and Basque Government and published in the major journals (Artificial Intelligence, Computational Linguistics...) and conferences (ACL, EMNLP, EACL, IJCAI, etc.) related to Artificial Intelligence and Natural Language Processing.

My research is focused on multilingual and crosslingual Natural Language Processing, information extraction, semantic processing, and large language models, with a particular interest in high-impact applications in specialized domains. I am currently the Principal Investigator of four projects: [CRITICS (2025–2028)](https://www.hitz.eus/critics/), a European CHIST-ERA IV Cofund project on multilingual translation of scientific knowledge with LLMs; [DeepThought (2025-2028)](https://www.hitz.eus/deepthought), a coordinated project on reasoning and alignment of large language models for multilingual and low-resource scenarios; [DeepMinor (2024–2026)](https://www.ixa.eus/node/13959), focused on multilingual and multidomain language models and benchmarks for low-resource settings; and [DeepKnowledge (2022–2026)](https://ixa2.si.ehu.eus/deepknowledge/), which explores deep language models for multilingual understanding and reasoning.

I teach Natural Language Processing at undergraduate, master’s, and doctoral levels, including the international online course [Introduction to Language Technology Applications](https://www.ixa.eus/iltapp/). I have supervised four completed PhD theses and am currently co-supervising 9 fully funded doctoral students and 6 master’s students.
