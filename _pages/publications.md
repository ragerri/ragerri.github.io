...
+ Ferrazzi, Pietro, Aitor Soroa and Rodrigo Agerri (2026). [Multilingual Medical Reasoning for Question Answering with Large Language Models.](https://arxiv.org/abs/2512.05658). In Findings of EMNLP 2026.
+ Zubiaga, Irune, Aitor Soroa and Rodrigo Agerri (2026). [Towards Reliable Multilingual LLMs-as-a-Judge: An Empirical Study.](https://arxiv.org/abs/2605.28710) In Findings of EMNLP 2026.
+ Mishra, N., Ballester, J. & Agerri, R. [Cross-lingual transfer with multilingual language models for influenza-like-illness detection in social media texts](https://doi.org/10.1038/s44482-026-00020-y). [In npj Digit. Public Health](https://www.nature.com/npjdigipubhealth/) 1, 16 (2026). [https://doi.org/10.1038/s44482-026-00020-y](https://doi.org/10.1038/s44482-026-00020-y).
+ Jaione Bengoetxea, Itziar Gonzalez-Dios, and Rodrigo Agerri. 2026. [A Catalog of Basque Dialectal Resources: Online Collections and Standard-to-Dialectal Adaptations.](https://aclanthology.org/2026.dialres-1.16/) In [Proceedings of the First Workshop on Dialects in NLP — A Resource Perspective, pages 153–164](https://aclanthology.org/volumes/2026.dialres-1/), LREC 2026. Palma de Mallorca. Association for Computational Linguistics. [https://doi.org/10.63317/3zhrab5powcg.](https://doi.org/10.63317/3zhrab5powcg)
+ Rodrigo Agerri, Itziar Aldabe, Elena Cabrio, Mark Cieliebak, Jan Deriu, Mariana Flores, Jurgita Kapociute-Dzikiene, Dovile Kuiziniene, Arantza Rico, Aritz Ruiz-Gonzalez, Aitor Soroa, Mantas Vaskevicius and Serena Villata (2026).[CRITICS - Critical Science Without Borders: Language Models to Promote Critical Thinking in Science Education/](). In SEPLN 2026: 42nd International Conference of the Spanish Society for Natural Language Processing, León, Spain, 22-25 September 2026. 
+ Sanchez-Bayona, Elisa and Rodrigo Agerri (2026). [Meta4XNLI: A Cross-lingual Parallel Corpus for Metaphor Detection and Interpretation](https://doi.org/10.1162/COLI.a.20). In [Computational Linguistics](https://direct.mit.edu/coli) (MIT Press).
+ Boisson, Joanne, Jose Camacho-Collados, Elisa Sanchez-Bayona, and Rodrigo Agerri (2026). [The Interplay between Metaphors and NLP.](https://aclanthology.org/2026.acl-tutorials.6/). In Proceedings of the 64th Annual Meeting of the Association for Computational Linguistics (Volume 5: Tutorial Abstracts), pp. 11-12.
+ Nedjma Ousidhoum, Junho Myung, Carla Perez-Almendros, Jiho Jin, Amr Keleg, Meriem Beloucif, Yi Zhou, Rodrigo Agerri, Vladimir Araujo, Naomi Baes, James Barry, Joanne Boisson, Nancy F. Chen, Christine de Kock, Aleksandra Edwards, Joseba Fernandez de Landa, Mohamed Fazli Imam, Huda Hakami, Shu-Kai Hsieh, Joseph Marvin Imperial, Roy Ka-Wei Lee, Zhengyuan Liu, Chenyang Lyu, Younes Samih, Johan Sjons, Bryan Tan, Asahi Ushio, Weihua Zheng, Alice Oh, and Jose Camacho-Collados (2926). [SemEval-2026 Task 7: Everyday Knowledge Across Diverse Languages and Cultures.](https://aclanthology.org/2026.semeval-1.455/). In Proceedings of the 20th International Workshop on Semantic Evaluation (2026), pages 3823–3837, San Diego, California, USA. Association for Computational Linguistics.
...
+ Rodrigo Agerri, Itziar Aldabe, Elena Cabrio, Mark Cieliebak, Jan Deriu, Mariana Flores, Jurgita Kapočiūtė-Dzikienė, Dovilė Kuizinienė, Arantza Rico, Aritz Ruiz-González, Aitor Soroa, Mantas Vaškevičius, and Serena Villata. 2026. [CRITICS: Critical Science Without Borders by Translation of Scientific Knowledge.](https://aclanthology.org/2026.eamt-2.23/). In Proceedings of the 26th Annual Conference of the European Association for Machine Translation (Volume 2), pages 47–48, Tilburg, The Netherlands. European Association for Machine Translation.


## 2025

+ Olia Toporkov, Alan Akbik and Rodrigo Agerri (2025). [Lemma Dilemma: On Lemma Generation Without Domain- or Language-Specific Training Data](https://aclanthology.org/2025.findings-emnlp.988/). In EMNLP Findings 2025.
+ Blanca Calvo Figueras, Rodrigo Agerri (2025). [Benchmarking Critical Questions Generation: A Challenging Reasoning Task for Large Language Models](https://aclanthology.org/2025.findings-emnlp.302/). In EMNLP Findings 2025.
+ Ravi Kiran Chikkala, Tatiana Anikina, Natalia Skachkova, Ivan Vykopal, Rodrigo Agerri, and Josef van Genabith. 2025. [Automatic Fact-checking in English and Telugu](https://aclanthology.org/2025.lowresnlp-1.15/). In Proceedings of the First Workshop on Advancing NLP for Low-Resource Languages, pages 140–151, Varna, Bulgaria. INCOMA Ltd., Shoumen, Bulgaria.
+ Álvaro Rodrigo, Sergio Moreno-Álvarez, Alberto Pérez, Anselmo Peñas, Rodrigo Agerri, Javier Fruns-Jiménez, Inés Soria-Pastor (2025). [Overview of PROFE at IberLEF 2025: Language Proficiency Evaluation](http://journal.sepln.org/sepln/ojs/ojs/index.php/pln/article/view/6770). In [Procesamiento del Lenguaje Natural](http://journal.sepln.org/sepln/ojs/ojs/index.php/pln/issue/view/300), 75, 487-497.
...
[DeepKnowledge: Deep Multilingual Language Model Technology for Language Understanding](https://ceur-ws.org/Vol-3729/p30_rev.pdf). In SEPLN-CEDI-PD 2024: Seminar of the Spanish Society for Natural Language Processing: Projects and System Demonstrations, June 19-20, 2024, A Coruña, Spain.
